...
void PlyManager::ReadFile(Mesh& mesh,const char* fileName)
{
	...
	fscanf(nfile,"ply\nformat ascii 1.0\nelement vertex %d\n",&vcount);
	fscanf(nfile,"property float32 x\nproperty float32 y\nproperty float32 z\nelement face %d\n",&fcount);
	fscanf(nfile,"property list uint8 int32 vertex_indices\nend_header\n");
...
void PlyManager::Output(Mesh& mesh,const char* filename)
{
	...
	fprintf(nfile,"property float32 x\n");
	fprintf(nfile,"property float32 y\n");
	fprintf(nfile,"property float32 z\n");
	fprintf(nfile,"element face %d\n",mesh.Faces.size());
	fprintf(nfile,"property list uint8 int32 vertex_indices\n");
